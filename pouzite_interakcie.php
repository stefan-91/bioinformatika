...
<html lang="en">
	...
	<h2>Použité slová pre interakciu</h2>
...
function vypisPouziteInterakcie() {
    ...
    echo '<form action="pouzite_interakcie.php" method="POST">';
    ...
    echo '<input type="submit" value = "Vypísať použité interakcie">';
    ...
    $sql = "SELECT DISTINCT nazov FROM Pouzite_interakcie ORDER BY nazov ASC;";
